...
func Tracker_Routes(app *fiber.App) {
	...
	r.Get("/macros", func(c *fiber.Ctx) error { return handlers.Get_Daily_Nutrients(c, setup.DB) })
	r.Get("/macros_list", func(c *fiber.Ctx) error { return handlers.Get_Daily_Nutrients_List(c, setup.DB) })
